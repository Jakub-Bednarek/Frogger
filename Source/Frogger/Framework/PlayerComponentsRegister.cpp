...
// Sets default values
APlayerComponentsRegister::APlayerComponentsRegister() { PrimaryActorTick.bCanEverTick = true; }
...
void APlayerComponentsRegister::RegisterLevelComponentsSet(TSoftObjectPtr<UWorld> Level,
...
void APlayerComponentsRegister::CreatePlayerComponents()
{
    ...
    else
    {
        ...
        UE_LOG(LogTemp, Verbose, TEXT("No player level specific components assigned to level: %s"),
               (*CurrentLevelName));
    }
